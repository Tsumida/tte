...
pub static ERR_OB_ORDER_CANCELED: i32 = 1000106; // 订单已经被取消,幂等提示
...
pub static ERR_OMS_DUPLICATE_CLI_ORD_ID: i32 = 1000204; // client_order_id重复, 等于下单重复，幂等提示
...
pub static ERR_OMS_ORDER_CANCELED: i32 = 1000210; // 订单已经被取消,幂等提示
pub static ERR_OMS_INVALID_ACTION: i32 = 1000211; // 订单状态不支持该操作
