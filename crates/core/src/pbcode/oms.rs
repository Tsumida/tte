...
impl OrderState {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::UndefinedOrderState => "UndefinedOrderState",
            Self::New => "New",
...
impl Direction {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::UndefinedDirection => "UndefinedDirection",
            Self::Buy => "Buy",
            Self::Sell => "Sell",
        }
    }
...
impl TimeInForce {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::UndefinedTif => "UndefinedTIF",
            Self::Gtk => "GTK",
            Self::Fok => "FOK",
            Self::Ioc => "IOC",
        }
...
impl OrderType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::UndefinedOrderType => "UndefinedOrderType",
            Self::Limit => "Limit",
            Self::Market => "Market",
        }
    }
...
impl StpStrategy {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::UndefinedStpStrategy => "UndefinedSTPStrategy",
            Self::CancelTaker => "CancelTaker",
            Self::CancelMaker => "CancelMaker",
            Self::CancelBoth => "CancelBoth",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl BizAction {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::UndefinedBizAction => "UndefinedBizAction",
...
impl AdminAction {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::UndefinedAdminAction => "UndefinedAdminAction",
            Self::TakeSnapshot => "TakeSnapshot",
            Self::UpdateTradePairConfig => "UpdateTradePairConfig",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl TradePairState {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::UndefinedPairState => "UndefinedPairState",
            Self::TradingPair => "TradingPair",
            Self::SuspendedPair => "SuspendedPair",
...
pub mod oms_service_server {
    ...
    #[async_trait]
    pub trait OmsService: std::marker::Send + std::marker::Sync + 'static {
                ...
                "/oms.OMSService/PlaceOrder" => {
                    ...
                    for PlaceOrderSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as OmsService>::place_order(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/oms.OMSService/CancelOrder" => {
                    ...
                    for CancelOrderSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OmsService>::cancel_order(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/oms.OMSService/TransferFreeze" => {
                    ...
                    for TransferFreezeSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OmsService>::transfer_freeze(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/oms.OMSService/Transfer" => {
                    ...
                    for TransferSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OmsService>::transfer(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/oms.OMSService/GetOrderDetail" => {
                    ...
                    for GetOrderDetailSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OmsService>::get_order_detail(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/oms.OMSService/GetBalance" => {
                    ...
                    for GetBalanceSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OmsService>::get_balance(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/oms.OMSService/TakeSnapshot" => {
                    ...
                    for TakeSnapshotSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OmsService>::take_snapshot(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/oms.OMSService/UpdateTradePairConfig" => {
                    ...
                    for UpdateTradePairConfigSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as OmsService>::update_trade_pair_config(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    impl<T> Clone for OmsServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "oms.OMSService";
    impl<T> tonic::server::NamedService for OmsServiceServer<T> {
...
pub mod match_engine_service_server {
    ...
    #[async_trait]
    pub trait MatchEngineService: std::marker::Send + std::marker::Sync + 'static {
        /// 内部使用
        async fn take_snapshot(
            &self,
            request: tonic::Request<super::TakeSnapshotReq>,
    ...
    #[derive(Debug)]
    pub struct MatchEngineServiceServer<T> {
        inner: Arc<T>,
        accept_compression_encodings: EnabledCompressionEncodings,
        send_compression_encodings: EnabledCompressionEncodings,
        max_decoding_message_size: Option<usize>,
    ...
    impl<T> MatchEngineServiceServer<T> {
        pub fn new(inner: T) -> Self {
            Self::from_arc(Arc::new(inner))
        }
        pub fn from_arc(inner: Arc<T>) -> Self {
                ...
                "/oms.MatchEngineService/take_snapshot" => {
                    ...
                    for take_snapshotSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as MatchEngineService>::take_snapshot(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    impl<T> Clone for MatchEngineServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    /// Generated gRPC service name
    pub const SERVICE_NAME: &str = "oms.MatchEngineService";
    impl<T> tonic::server::NamedService for MatchEngineServiceServer<T> {
        const NAME: &'static str = SERVICE_NAME;
    }
}
